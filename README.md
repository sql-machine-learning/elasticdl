...
**ElasticDL is still under active development, and we have not extensively tested in production environments. We open source this early-stage project with the hope of encouraging further work on fault-tolerance and elastic scheduling from the community.**
