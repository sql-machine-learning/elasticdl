...
#  --output=model_output
#
#bash scripts/validate_job_status.sh test-mnist
...
#bash scripts/validate_job_status.sh test-mnist-evaluate
#
#elasticdl predict \
#  --image_base=elasticdl:ci \
#  --model_zoo=model_zoo \
...
#  --image_pull_policy=Never
#
#bash scripts/validate_job_status.sh test-mnist-predict
