...
class Worker(object):
    ...
    def _run(self):
        ...
        while not self._exiting:
            ...
            with self._graph.as_default():
                dataset = self._create_dataset(data_file, file_offset,
                ...
                if not self._model_initialized:
                    ...
                    var_dict = {v.name.split(
                        ":", 1)[0]: v for v in trainable_vars}
    ...
    def _parpare_for_training(self, dataset):
        ...
        self._iter_handle = tf.placeholder(
            tf.string, shape=[], name='iter_handler')
        data_iter = tf.data.Iterator.from_string_handle(self._iter_handle,
        ...
        self._grads = {gv[1].name.split(":", 1)[0]: gv[0]
