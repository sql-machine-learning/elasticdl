...
class HOROVOD_CONFIG(object):
    RENDEZVOUS_ADDR_ENV = "HOROVOD_GLOO_RENDEZVOUS_ADDR"
    RENDEZVOUS_PORT_ENV = "HOROVOD_GLOO_RENDEZVOUS_PORT"
    RANK_ENV = "HOROVOD_RANK"
    SIZE_ENV = "HOROVOD_SIZE"
    CONTROLLER_ENV = "HOROVOD_CONTROLLER"
    CPU_OPERATIONS_ENV = "HOROVOD_CPU_OPERATIONS"
    HOSTNAME_ENV = "HOROVOD_HOSTNAME"
