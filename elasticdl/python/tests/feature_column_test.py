...
class EmbeddingColumnTest(unittest.TestCase):
    ...
    def test_concat_column(self):
        ...
        item_id_user_id_concat = feature_column.concatenated_categorical_column(
            [user_id, item_id]
        )
...
class ConcatenatedCategoricalColumnTest(unittest.TestCase):
    def test_name(self):
        ...
        concat = feature_column.concatenated_categorical_column([a, b, c])
    ...
    def test_is_v2_column(self):
        ...
        concat = feature_column.concatenated_categorical_column([a, b])
