...
class Parameters(object):
    ...
    def _init_non_embedding_params(self, tensors_pb):
        for pb in tensors_pb:
            ...
            # Please note that `tf.Variable` will do something magic. If you
            # pass a name "somename" to a `tf.Variable`, the final variable
            # name will be "somename:0". So we variable.name is meaningless,
            # we must avoid use it in PS side.
