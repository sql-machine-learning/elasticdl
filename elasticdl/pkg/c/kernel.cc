...
void (*SGDFunc[])(void*, void*, float, long long) = {NULL, NULL, NULL, NULL, NULL, NULL, SGDFloat32, SGDFloat64, NULL};

void SGD(void* grad, void* param, float lr) {
    SGDFunc[((Vector*)grad)->Dtype](((Vector*)grad)->Data, ((Vector*)param)->Data, lr, ((Vector*)grad)->Length);
}
...
void (*AdamFunc[])(void*, void*, void*, void*, float, long long, long long, float, float, float, void*) = {NULL, NULL, NULL, NULL, NULL, NULL, AdamFloat32, AdamFloat64, NULL};
...
void Adam(void* grad,
          ...
          float epsilon,
          void* max_square) {
    void *max_square_data = NULL;
    if(max_square!=NULL) max_square_data = ((Vector*)max_square)->Data;
    AdamFunc[((Vector*)grad)->Dtype](((Vector*)grad)->Data, ((Vector*)param)->Data, ((Vector*)m)->Data, ((Vector*)v)->Data, lr, ((Vector*)grad)->Length, step, beta1, beta2, epsilon, max_square_data);
}